...
extern	uint8_t ST25DV_ReadAFIMode(uint8_t *mbmode);
extern	uint8_t ST25DV_ReadEHReg(uint8_t *ehreg);
extern	uint8_t ST25DV_WriteEHReg(uint8_t ehreg);
extern	uint8_t ST25DV_ReadMBMode(uint8_t *mbmode);
extern	uint8_t ST25DV_SetMBMode(uint8_t mbmode);
...
extern	uint8_t ST25DV_SetEH_Ctrl_Dyn(void);
extern	uint8_t ST25DV_ClearEH_Ctrl_Dyn(void);
extern	uint8_t ST25DV_Get_Ctrl_Dyn(void);
...
extern	void st25dv_Initialize(uint8_t *whoami,uint8_t *status,uint8_t *password);
